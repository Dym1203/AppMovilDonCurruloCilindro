...
public final class FragmentInicioBinding implements ViewBinding {
  ...
  private FragmentInicioBinding(@NonNull LinearLayout rootView, @NonNull GridView gvCategorias) {
  ...
  public static FragmentInicioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInicioBinding((LinearLayout) rootView, gvCategorias);
    }
