...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout linearParte5;
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnRecuperarPass, @NonNull Button btnRegistrarse,
      @NonNull CheckBox chkPromociones, @NonNull LinearLayout linearParte3,
      @NonNull LinearLayout linearParte4, @NonNull LinearLayout linearParte5,
    ...
    this.linearParte5 = linearParte5;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linearParte5;
      LinearLayout linearParte5 = ViewBindings.findChildViewById(rootView, id);
      if (linearParte5 == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, btnLogin, btnRecuperarPass,
          btnRegistrarse, chkPromociones, linearParte3, linearParte4, linearParte5, tietClave,
          tietCorreo, tilClave, tilCorreo);
    }
